      ...
      <div className="overflow-y-auto h-[calc(500px-88px)]">
        {activities.map((activity) => {
          ...
          return (
            <div
              key={activity.id}
              className="flex items-start gap-4 p-4 hover:bg-teal-800/50 transition-all duration-200 border border-teal-700/30 hover:border-teal-600/50"
            >
              {/* Icon */}
              <div
