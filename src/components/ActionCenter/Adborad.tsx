  ...
  const slides = [
    {
      ...
      title:
        "How This New Wallet Turned $1,000 Into 10,000 Virgen Points In a Week Using Dexter's Volume Loop",
      subtitle: "That only took less than 15 secs to create",
      description:
        "Dexter's fully automated volume loop strategy is helping countless users farm Virgen points at scale, without manual trading or complex setup.",
              ...
              <div className="relative z-10 flex h-full flex-1">
                ...
                <div className="flex-1 p-4 flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-2 mb-6">
                    <div className="flex items-center gap-2 text-nowrap text-base font-bold text-gray-500">
                      <FaFire className="w-4 h-4 text-yellow-600" />
                      <span className="text-primary-100 text-base font-bold">
                        Available Now!
                      </span>{" "}
                      Fully Automated Trading Loops
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 my-6 w-[70%]">
                    ...
                    <p className="text-teal-200 text-sm opacity-90 pb-7">
                      {slide.subtitle}
                    </p>
