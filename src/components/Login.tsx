...
const Login = () => {
  ...
  return (
    <div className="relative h-full w-full">
      <div className="absolute h-full w-full !bg-[url('/Login/background.png')] bg-[position:30%] bg-[size:cover] bg-[repeat:no-repeat] z-10 p-5 after:content-[''] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:shadow-[0px_0px_0px_9999px_rgba(0,0,0,0.68)]"></div>
      <div className="relative z-20 w-full h-[calc(100vh-6.8vh)] px-14  flex flex-col">
        <div className="flex py-4">
          <Image src="/Login/logo.png" alt="Dexter" height={135} width={150} />
        </div>
        <div className="relative w-full flex-1 flex flex-col space-y-10 items-center justify-center ">
          ...
          <div className="relative w-full flex flex-start">
            <button
              className="py-4 px-24 bg-primary-100 text-black text-base text-center font-bold rounded-lg"
