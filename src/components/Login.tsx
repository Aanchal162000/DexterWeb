                ...
                <div className="relative w-full flex-1 flex flex-col sm:pt-0 xs:pt-[30vh] pt-[20vh] space-y-6 md:space-y-10 items-center justify-center">
                    ...
                    <div className="relative flex flex-col space-y-5 w-full sm:pt-8">
                        ...
                        <div className="-mx-4 w-screen sm:hidden block overflow-hidden">
                            <Swiper slidesPerView={1.3} spaceBetween={20} centeredSlides={true} className="mySwiper mt-10">
                                    ...
                                    <SwiperSlide>
                                        ...
                                        >
                                            <div className="relative w-full h-full bg-[#041820] sm:rounded-3xl rounded-xl items-center justify-start p-5">
                                                ...
                                                <h3 className="text-primary-100 sm:text-lg text-sm font-bold mb-2">{box.title}</h3>
