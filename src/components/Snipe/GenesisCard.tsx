      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2">
          ...
          {status === "live" && (
            <button
              onClick={handleSnipe}
              className="px-4 py-2 rounded-lg bg-cyan-500/10 text-cyan-500 border border-cyan-500/30 hover:bg-cyan-500/20 transition-all duration-300 flex items-center gap-2"
            >
