...
function SliderHandler({
  marketCapBuyRange,
  setMarketCapBuyRange,
}: {
  marketCapBuyRange: number;
  setMarketCapBuyRange: (value: number) => void;
}) {
  return (
    <Slider
      ...
      domain={[0, 60000000]}
      step={1000000}
      values={[marketCapBuyRange]}
      onUpdate={(values) => setMarketCapBuyRange(values[0])}
    >
      ...
      <Ticks values={[0, 20000000, 40000000, 60000000]}>
        {({ ticks }) => (
